...
import '../api/scamshield_api.dart';
import '../api/models/analysis_request.dart';
import '../api/models/analysis_response.dart';

final apiProvider = Provider<ScamShieldApi>((ref) => ScamShieldApi());
...
class ChatNotifier extends StateNotifier<AsyncValue<List<ChatMessage>>> {
  ...
  Future<void> send({required String text, String? imageBase64}) async {
    ...
    try {
      ...
      final response = await _api.analyze(request);
